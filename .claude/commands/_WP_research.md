...
║   ENTRY:                                                                 ║
║     NORMAL: /_WP_assess → THIS                                        ║
║   EXIT:                                                                  ║
║     NORMAL: THIS → /_WP_discovery                                     ║
║   PHASE: Knowledge                                                      ║
...
- Lücken aktiv füllen (→ `/_WP_chapterGap`)
...
3. Falls unter Minimum:
   ...
   - Grund: `/_WP_discovery` kann Lücken später füllen
...
- Ohne SOURCES Collection können `/_WP_chapterWrite` und `/_WP_chapterGap` nicht arbeiten
...
- Exit: `coverage_score >= 0.9` → `/_WP_chapterWrite`
