# /_R_WP_structure - Paper-Strukturextraktion
...
- Inhalte schreiben → Das macht /_R_WP_write
- Quellen pro Kapitel zuordnen → Das macht /_R_WP_assess
- RAG-Queries ausführen → Das macht /_R_WP_assess
- LaTeX-Dokument rendern → Das macht /_R_WP_finalize
...
→ Nächster Schritt: /_R_WP_assess (Kapitel 1)
```
