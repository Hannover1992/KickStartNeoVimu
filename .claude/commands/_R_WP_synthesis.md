# /_R_WP_synthesis - Draft Synthesis & Consensus
...
type: Standard
chain_position: AFTER=/_R_WP_review, BEFORE=/_R_WP_reflect
...
```
╔══════════════════════════════════════════════════════════════════════════╗
║ STANDARD-COMMAND: /_R_WP_synthesis                                       ║
╠══════════════════════════════════════════════════════════════════════════╣
...
║ [4] POSITION:  LINEAR - AFTER /_R_WP_review, BEFORE /_R_WP_reflect      ║
...
### ESKALATION
- Fehlt review-matrix.json → NOTIFY Error → empfehle /_R_WP_review erneut
...
**ZIEL:** Pipeline-State fuer /_R_WP_reflect vorbereiten
...
- [ ] session-state.json zeigt next_step = /_R_WP_reflect
...
✗ Synthesis FAILED for Chapter {N}:
  ...
  → Fix: Run /_R_WP_review again to generate review-matrix.json
```
...
|-----------|---------|----------|--------|
| BLOCKING | review-matrix.json fehlt | STOP + Empfehle /_R_WP_review erneut | Error |
| BLOCKING | 0 Top-K Drafts verfuegbar | STOP + Pipeline-Abbruch | Error |
| BLOCKING | chapter-{N}-model.md fehlt | STOP + Empfehle /_R_WP_model pruefung | Error |
