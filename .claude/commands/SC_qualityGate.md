...
**Status:** NEU v2.2 (ersetzt _analyse Sektion B Quality-Checks)
**Actor:** QUALITY-GATE
...
║    4. synthese/{NAME}-ERGEBNIS{CYCLE}.md (SRS-Score)                    ║
...
║      → Blind-Spot-Trigger (T1-T5, optional)                             ║
...
**BSD-Trigger:** OPTIONAL (nicht PFLICHT, aber empfohlen)
...
| 2: Kohäsion | ✅ OK | Split ausgeführt |
| 3: Feature-Abschluss | 🔄 85% | 1-2 Zyklen bis Abschluss |
| 4: BSD-Trigger | ⚠ T4 | Canary Probe optional |
