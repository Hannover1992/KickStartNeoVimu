...
require('lazy').setup({
  ...
  { -- Useful plugin to show you pending keybinds.
    ...
    opts = {
      ...
      spec = {
        ...
        { '<leader>sD', group = '[D]irty (vs develop)' },
        { '<leader>sDt', group = 'Dirty [T]ests' },
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      -- Helfer ausgelagert nach lua/shared/dirty.lua (reine Verschiebung, Verhalten identisch).
      -- Grund: die Dirty-TEST-Keys sDti/sDtI/sDtu/sDtU liegen in keybindings/tests.lua (brauchen
      -- write_it_script & Co.) und muessen dieselbe Dirty-Liste sehen wie sDo/sDb/sDS hier.
      local dirty = require('shared.dirty')
      local is_code_file, dirty_profile, in_profile = dirty.is_code_file, dirty.profile, dirty.in_profile
      local git_dirty_raw, get_dirty_files = dirty.git_dirty_raw, dirty.get_dirty_files
